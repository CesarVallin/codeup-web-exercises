"use strict";
console.log(`hello from Codeup_loops-lecture.js, external JS`);
...
// let userInput;
// do {
//     userInput = confirm("Would you like to see the current time?");
//     if (userInput) {
...
// or simply typing while(userInput)

// let willContinue;
// do {
//     willContinue = confirm(`Would you like to see the current time?`);
//     if (willContinue) {
//         alert(new Date().toLocaleString());
//     }
// } while(willContinue)
